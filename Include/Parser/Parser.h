...
private:
    ...
    ERROR_TYPE AssignmentStatement(TokenPR currToken, ParseNodePR nodeOut, bool required = false); // DONE TESTED
    ERROR_TYPE IfStatement(TokenPR currToken, ParseNodePR nodeOut, bool required = false); // DONE TESTED
    ERROR_TYPE LoopStatement(TokenPR currToken, ParseNodePR nodeOut, bool required = false); // DONE TESTED
    ERROR_TYPE ReturnStatement(TokenPR currToken, ParseNodePR nodeOut, bool required = false); // DONE TESTED
    ERROR_TYPE ProcedureCallOrName(TokenPR currToken, ParseNodePR nodeOut, bool required = false); // <procedure_call> and <name> both start with identifier...  DONE TESTED
    ERROR_TYPE ArgumentList(TokenPR currToken, ParseNodePR nodeOut, bool required = false); // DONE TESTED
    ERROR_TYPE Destination(TokenPR currToken, ParseNodePR nodeOut, bool required = false); // <destination> is same as <name>...  DONE TESTED
